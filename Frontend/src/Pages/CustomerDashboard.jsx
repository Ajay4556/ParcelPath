  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg w-full max-w-2xl relative">
        ...
        {/* Trip Details */}
        <p className="mb-2">
          <strong>Pickup:</strong> {trip.pickupLocation} at {trip.pickupTime} on {new Date(trip.pickupDate).toLocaleDateString()}
        </p>
        <p className="mb-2">
        ...
        <p className="mb-4">
          ...
          {isDelivered ? (
            ...
            <span className="text-orange-500">
              ...
              {dropoffDate.toLocaleDateString()} at {trip.dropoffTime}
            </span>
          )}
        </p>
        ...
        <p className="mb-2">
          <strong>Shipping Name:</strong> {checkOutInfo?.shippingAddress?.firstName} {checkOutInfo.shippingAddress.lastName}
        </p>
        <p className="mb-2">
          <strong>Shipping Address:</strong> {checkOutInfo.shippingAddress.streetAddress}, Apt{" "}
          {checkOutInfo.shippingAddress.aptNumber}, {checkOutInfo.shippingAddress.state}, {checkOutInfo.shippingAddress.zip}
        </p>
        <p className="mb-2">
          <strong>Pickup Name:</strong> {checkOutInfo.pickupAddress.firstName} {checkOutInfo.pickupAddress.lastName}
        </p>
        <p className="mb-2">
          <strong>Pickup Address:</strong> {checkOutInfo.pickupAddress.streetAddress}, Apt{" "}
          {checkOutInfo.pickupAddress.aptNumber}, {checkOutInfo.pickupAddress.state}, {checkOutInfo.pickupAddress.zip}
        </p>
        <p className="mb-2">
          <strong>Parcel Weight:</strong> {checkOutInfo.weight} g
        </p>
        <p className="mb-2">
          <strong>Price Paid:</strong> ${checkOutInfo.calculatedPrice.toFixed(2)}
        </p>
        <p className="mb-4">
